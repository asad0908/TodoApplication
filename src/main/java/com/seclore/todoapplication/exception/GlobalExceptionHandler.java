package com.seclore.todoapplication.exception;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorDTO> duplicateKeyExceptionHandler(DuplicateKeyException e) {
		String message = e.getMessage();
		message = message.substring(message.lastIndexOf(": ") + 2);
		// System.out.println("Duplicate key");
		return new ResponseEntity<ErrorDTO>(new ErrorDTO(HttpStatus.CONFLICT, message), HttpStatus.CONFLICT);
	}
	...
	public ResponseEntity<ErrorDTO> emptyDataExceptionHandler(EmptyResultDataAccessException e) {
		// System.out.println("Empty data");
		String message = "No records found!";
		return new ResponseEntity<ErrorDTO>(new ErrorDTO(HttpStatus.NOT_FOUND, message), HttpStatus.NOT_FOUND);
	}
	...
	public ResponseEntity<ErrorDTO> invalidInputExceptionHandler(SQLIntegrityConstraintViolationException e) {
...
//		message = message.substring(message.lastIndexOf(": ") + 2, message.lastIndexOf("at row"));
		return new ResponseEntity<ErrorDTO>(new ErrorDTO(HttpStatus.BAD_REQUEST, message), HttpStatus.BAD_REQUEST);
	}
	...
	public ResponseEntity<ErrorDTO> dataViolationceptionHandler(DataTruncation e) {
